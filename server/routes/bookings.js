  ...
  book
    ...
    .then(() => {
      ...
      return transporter.sendMail({
        ...
        <body>
        <p><img src="https://www.lamalmaisonnice.com/wp-content/uploads/2021/06/Sans-titre-2-1024x621.png" height="300px" width="800px">
        </p>
        ...
        <img src="https://i2.wp.com/www.bafonline.org.uk/wp-content/uploads/2017/11/Details-button.png" width="250px" height="60px"></p>
        <strong>Hotel: </strong>${req.body.hotelNow}</p>
      ...
      </div><p><img src="https://www.kashmirpen.com/wp-content/uploads/2020/07/booked.png" width="250px" height="80px"/></p><p><strong>For any enquiry or cancellation of your booking, contact us on this number +91 7836528737 or write us to this email.</strong></p>
      <p><strong>Warm regards,</strong></p><p><img src="https://hydraislandgreece.com/wp-content/uploads/2019/12/HotelBlueIcon-300x250.png" width="60px"/><h3><strong>Booking Engine</strong></h3></p></body></html>`, // html body
      });
    })
    .catch((err) => {
